...
import useOrderPayCash from "./../../hook/checkout/order-pay-cash-hook";
import { ToastContainer } from "react-toastify";
import notify from "./../../hook/useNotifaction";
import useOrderPayCard from "./../../hook/checkout/order-pay-card-hook";
import useGetAllUserCart from "./../../hook/cart/get-all-user-cart-hook";

const ChoosePayMethoud = () => {
  const [res] = useViewAddresses();
  const [handelChooseAddress, addressDetalis, handelCreateOrderCash] =
    useOrderPayCash();
  const [handelCreateOrderCARD] = useOrderPayCard(addressDetalis);
