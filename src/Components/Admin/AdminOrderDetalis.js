...
import useGetOrderDetalis from "./../../hook/admin/get-order-detalis-hook";
import useChangeOrderStatus from "./../../hook/admin/change-order-status-hook";
import { ToastContainer } from "react-toastify";

const AdminOrderDetalis = () => {
  const { id } = useParams();
  const [orderData, cartItems] = useGetOrderDetalis(id);
